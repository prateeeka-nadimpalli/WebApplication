...
<body>
<%
		String user = (String)session.getAttribute("clubname");
int id=(int)session.getAttribute("clubId");
		 %>
<!-- ======= Header ======= -->
  ...
  <div class="w3-bar w3-black w3-card">
    <div class="w3-right w3-hide-small">
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active ; w3-bar-item w3-button w3-padding-16"><a href="AddEvent.jsp">AddEvent</a></li>
          <li class="active ; w3-bar-item w3-button w3-padding-16"><a href='DisplayAllEvent?clubId=<%=id%>'>Display all events</a></li>
          <li class="active ; w3-bar-item w3-button w3-padding-16"><a href='#'>Logout</a></li>
