  ...
  <div class="w3-bar w3-black w3-card">
    <div class="w3-right w3-hide-small">
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active ; w3-bar-item w3-button w3-padding-16"><a href="AddClub.jsp">AddClub</a></li>
          <li class="w3-bar-item w3-button w3-padding-16"><a href="clubs.jsp">Clubs</a></li>
           <li class="w3-bar-item w3-button w3-padding-16"><a href="DisplayAllClub.jsp">AllClubs</a></li>
