<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.ArrayList,com.ts.dto.Event"%>
...
<main id="main">
    <section id="services" class="services">
      <div class="container">
		...
		<c:forEach var="event" items="${eventsData}">
			
			<div class = "card-horizontal"></div>
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="100">
              <h4 class="title"><a href="">${event.eventname}</a></h4>
              <p>${event.description}</p>
             <a href='DeleteEvent?eventid=${event.eventid}&clubId=${clubId}' <button type="button" class="btn btn-outline-danger" style="float:right">Delete</button>></a>
